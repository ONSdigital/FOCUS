...
output_cca_path = os.path.join(os.getcwd(), 'raw_inputs', 'subset_data', 'large_subset_lsoa_cca_nomis.csv')
...
subset_filter = os.path.join(os.getcwd(), 'raw_inputs', 'subset_data', 'large_subset_filter.csv')
...
output_JSON_path = os.path.join(os.getcwd(), 'inputs', 'large_subset2_lsoa_nomis.JSON')
