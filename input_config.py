...
output_cca_path = os.path.join(os.getcwd(), 'raw_inputs', '2021_cca.csv')
...
input_JSON_template = os.path.join(os.getcwd(), 'templates', '2021.JSON')  # JSON template to use
output_JSON_path = os.path.join(os.getcwd(), 'inputs', 'full_2021.JSON')
